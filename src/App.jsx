...
const App = () => {
  ...
  return (
    <>
      <main className='main w-full h-full relative overflow-hidden select-none'>
        <div
          id='cursor'
        ...
        <section className='w-full  overflow-hidden bg-heading-white'>
          <BrandsPage/>
        </section>

        <section className='w-full flex-center h-[100vh] overflow-hidden bg-heading-white '>
          <Services/>
        </section>
