...
const BrandsPage = () => {
    ...
    return (
        <section className='padding-x'>
            ...
            {/* for small screens */}
            <div className='sm:hidden text-[7vw] md:text-[4vw] leading-[8vw] md:leading-[4vw] font-nb flex flex-col justify-center w-full mt-[20px] '>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;We are a venture firm
                    and digital agency. Our
                    mission it to transform
                    founders' vision into
                    remarkable brands.Choose
                    traditional compensation or
                    an equity offset through our
                    Venture Model - your vision,
                    your decision</span>
            </div>
        </section>
    );
